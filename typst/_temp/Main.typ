...
Природные липиды обычно представляют собой смеси алифатических соединений различных классов, характеризуемых определенным числом тех или иных функциональных групп (стр. 24). Для предварительного фракционирования этих смесей на отдельные классы и выделения триглицеридов, ди- и моноглицеридов, жирных кислот, метиловых эфиров и т. д. служит метод адсорбционной хроматографии. Не случайно принцип хроматографии был открыт и применен М. С. Цветом в 1903 г. [37] как средство адсорбционного разделения именно липидных растительных пигментов. Открытая повторно в 1931 г. Куном и Ледерером [589], адсорбционная хроматография была впервые использована в анализе алифатических липидов Кауфманом в 1936 г. [501] и Траппе в 1940 г. [941]; до появления распределительной и газо-жидкостной хроматографии она в течение 10—15 лет служила основным методом разделения этих соединений. За последние годы данный вид хроматографии пережил «второе рождение» благодаря развитию методов адсорбционного разделения на бумаге и, особенно, тонкослойной хроматографии. В настоящее время исследователи в области биохимии липидов повседневно используют адсорбционную хроматографию в препаративном и аналитическом масштабе; она является единственным хроматографическим методом фракционирования сложных смесей липидов природного происхождения на отдельные классы и широко применяется для исследования олефинового состава липидов в пределах одного класса. Адсорбционной хроматографии липидов посвящено несколько сот экспериментальных исследований и ряд обзоров [71, 225, 226, 278, 389, 391, 682, 687, 722, 831, 832, 999].
...
Кроме ступенчатого элюирования в колоночной хроматографии липидов широко применяют градиентное элюирование, особенно при разделении смеси из многих компонентов, не сильно различающихся по полярности [225]. Раствор полярного растворителя концентрации С в неполярном растворителе непрерывно поступает в течение времени _t_ со скоростью _R_ в неполярный растворитель, имеющий объем _V_. Смесь непрерывно перемешивается и с той же скоростью _R_ подается в адсорбционную колонку. Концентрация _Е_ полярного растворителя в растворе, поступающем в колонку, определяется уравнением $Е = C (C/e^(Rt/V))$, где _e_ — основание натуральных логарифмов. Изменяя величину _V_, можно выбрать требуемый для данного разделения градиент — выпуклый, линейный или вогнутый (рис. 1) [376, 1000].
...
Условия проведения адсорбционной хроматографии на фильтровальной бумаге, пропитанной кремнекислотой, приведены в табл. 2. Природную смесь липидов разделяют на классы на кислой и нейтральной бумаге, используя смеси неполярных растворителей — петролейного эфира, бензола, эфира. Отдельные классы располагаются, начиная от старта, в обычной последовательности (стр. 24). Разделение липидов улучшается при отсутствии в бумаге ионов $Na⁺$ и $Cl⁻$. С увеличением полярности растворителя подвижность липидов на бумаге возрастает [219]. При помощи неполярных растворителей можно разделить по числу _e_ эфиры холестерина и жирных кислот — насыщенных, олеиновой, линолевой и линоленовой + арахидоновой. Чистота полученных фракций была подтверждена газо-жидкостной хроматографией. Для разделения смеси эфиров холестерина в нижний левый угол квадрата бумаги, пропитанной кремнекислотой, помещали исследуемую пробу и разделяли смесь петролейным эфиром в одном направлении — по _e_. Затем среднюю и правую части квадрата пропитывали жидким парафином и проводили распределительную хроматографию по числу _m_ в направлении, перпендикулярном первому, применяя смесь $СН₃COOH$, $CHCl₃$ и жидкого парафина (16:3: 1) в качестве растворителя [286, 723]. Сочетание адсорбционного и распределительного метода в виде двумерной хроматографии использовали также для разделения липидов листьев, причем в одном направлении бумагу пропитывали $ZnCO₃$, а в другом направлении — жидким парафином. Нисходящую хроматографию на бумаге Ватман № 40, пропитанной кремнекислотой, применяли для эффективной очистки липидов от примесей нелипидной природы [100, 113].

Условия обнаружения насыщенных и ненасыщенных нейтральных липидов и жирных кислот приведены в табл. 2. Лучшим неспецифическим проявителем для всех липидов является Родамин 6 G в 2 н. растворе $NaOH$; после опрыскивания желтые пятна

#align(center)[
  #strong[Таблица 2] \
  #strong[Условия адсорбционной хроматографии липидов на фильтровальной бумаге Ватман № 1, пропитанной кремнекислотой]
]
...
#table(
  ...
  [Эфиры стеринов, триглицериды, холестерин, диглицериды, жирные кислоты], [$Na₂SiO₃$ в воде, $d = 1,28$; 5 н. $HCl$], [Диэтиловый эфир: петролейный эфир: гептан = 8:50:50], [5,5 час., 27°], [0,1%-ный Судан черный Б в 60%-ном этаноле (для липидов); 20%-ная серная кислота в $(CH₃CO)₂O$ (для стеринов); 1%-ный ацетат Cu (для жирных кислот)], [[219, 220]],
  [Сложные эфиры холестерина и жирных кислот — насыщенных, оленовой, линолевой, линоленовой, арахидоновой], [37% $Na₂SiO₃$ в воде; 4 н. $HCl$], [Бензол: гексан = 1:9], [1,5 час., 27—30°], [То же, пары иода (для ненасыщенных липидов), фосфорномолибденовая кислота (для стеринов)], [[286]],
)

#pagebreak() // 7

липидов на пурпурном фоне наблюдают и фотографируют в УФ-свете [427]. Абсолютная и относительная величины $R_f$ при адсорбционной хроматографии сильно зависят от концентрации отдельных компонентов, свойств бумаги и других условий разделения. Индивидуальные классы или фракции липидов элюируют с бумаги метанольным раствором $HCl$ или другими растворителями и подвергают гидролизу или метанолизу [583, 932].
...
#align(center)[
  #strong[Таблица 3] \
  #strong[Адсорбционная хроматография липидов на бумаге из стеклянного волокна, пропитанной кремнекислотой, силикатом или силикагелем]
]
...
#table(
  ...
  [Моно-, ди- и триглицериды], [X-934-AH], [35%-ный $K₂SiO₃$, 4 н.$HCl$], [1—3%-ный эфир в изооктане], [20—30 мин., 21°], [50%-ная $H₂SO₄$ в воде, 100—200°], [[766, 767]],
  [Бромиды олеиновой, линолевой и линоленовой кислот и метиловые эфиры бромидов; моно- и диглицериды, ацетоглицериды], [934-AH], [1—2%-ный $K₂SiO₃$, 4 н.$HCl$], [Изооктан, 2—5%-ный эфир в изооктане], [48 мин., 22°], [100%-ная $H₂SO₄$, 200—300°], [[246]],
  [Моно-, ди- и триглицериды, жирные спирты, углеводороды], [934-AH], [38%-ный $Na₂SiO₃$, 4 н. $HCl$], [1—5%-ный эфир в петролейном эфире], [17—23 мин., 20°], [100%-ная $H₂SO₄$, 300—400°], [[170]],
  [Эфиры метанола с насыщенными и ненасыщенными кислотами, триглицериды, холестерин], [934-AH], [Пересыщенный раствор $SiO₂$: 10 частей воды и 3 части 5%-ного $NH₄Cl$], [Изооктан, 10—30%-ный изобутилацетат в изооктане], [20 мин., 20°], [100%-ная $H₂SO₄$, 200—300°], [[338]],
)
...
Благодаря разному числу полярных групп были разделены смеси моно-, ди- и триглицеридов — свободных и ацетилированных, смесь моно-, ди- и тририцинолеотриглицеридов, окси- и диоксистеариновые кислоты, окси- и эпоксижирные кислоты, а также метиловые эфиры этих жирных кислот [678, 684]. Из масла _Sapium sebiferum_ выделили глицериды 2,4-декадиеновой кислоты [675] (стр. 192). Сродство липидов к адсорбенту определяется не только числом, но и положением полярных групп в молекуле. Так, достигнуто разделение 9,10-диокси-, 6-, 14- и 2-оксистеаратов, 9-окси-9,12-октадекадиеноата и 13-окси-9,11-октадекадиеноата, а также 12,13- и 9,10-эпоксиоктадеценоата [741, 742, 744]. Полученные глицеролизом 1(3)- и 2-моно- и 1,3- и 1,2(2,3)-диглицериды разделяли на силикагеле; при движении моноглицеридов в слое гидроксилапатита 2-изомер из-за ацильной миграции превращался в 1(3)-моноглицерид. Чтобы избежать этого, смесь 1(3)- и 2-изомеров до разделения окисляли периодатом; при этом 1(3)-моноглицерид превращался в эфир гликолевого альдегида, который хорошо отделялся от 2-изомера [795].

Большой интерес представляют те исследования, в которых для разделения липидов с разным _e_ и различным положением двойных связей в цепи создавали новый градиент полярности путем присоединения к ненасыщенным связям тех или иных заместителей. После бромирования эфиров олеиновой, линолевой и линоленовой кислот их отделяли от насыщенных эфиров и разделяли между собой [871]. Озониды триглицеридов кукурузного, оливкового и соевого масел разделяли на силикагеле по _e_. Отдельные фракции элюировали и восстанавливали водородом над $PdO₂$. При этом цепи ацилов ненасыщенных кислот у девятого атома углерода разрывались, и в этих положениях возникали альдегидные группы. Насыщенные ацилы в данных условиях не изменялись. Продукты восстановительного озонолиза разделяли для определения $[S₃]$, $[S₂U]$, $[SU₂]$ и $[U₃]$ в типовом составе этих масел [797]. АОММО-Производные ненасыщенных метиловых эфиров разделяли по _e_, регенерировали исходные эфиры соляной кислотой и жирнокислотный состав каждой _e_-фракции определяли методом газо-жидкостной хроматографии [444].

Весьма эффективным оказалось фракционирование липидов на пластинке с силикагелем, пропитанным $AgNO₃$. Метиловые эфиры жирных кислот и триглицериды разделяются на таких пластинках в основном по олефиновому составу ($Δe = 1$). Этот метод может быть препаративным, а также использоваться для количественного определения триглицеридов [973]. Однако деление не всегда происходит строго по величине _e_, поскольку комплексообразующая способность ацилов с разным _e_ не прямо пропорциональна величине _e_. Если у S-ацилов эту способность принять равной нулю, то у олеата она равна 1, у линолеата $2 + a$, а у линолената $4 + 4a$, где $a < 1$. Можно видеть, что линолеат по этому признаку превосходит два остатка олеата, а линоленат — два остатка линолеата; триолеин ($e = 3$) совпадает по положению на хроматограмме с дипальмитолинолеином ($e = 2$), а стеародилиноленин ($e = 6$) превосходит по подвижности дилинолеолиноленин с семью двойными связями [318].

В ряду метиловых эфиров с $e = 1$ и 2 и одинаковым значением _m_, но с разным положением двойной связи в цепи, величина $R_f$ возрастала при увеличении расстояния между ненасыщенной связью и сложноэфирной группой [9]. Разделялись 1,3- и 1,2-позиционные изомеры диолеина, а также 1(3)- и 2-олео- и линолеодистеарины [87]. Для метиловых эфиров моно-, ди- и триеновых кислот, а также триглицеридов различие в геометрической конфигурации только одной двойной связи обеспечивало разделение, причем транс-изомеры двигались на пластинке, содержащей ионы $Ag⁺$, дальше, чем соответствующие цис-изомеры [734].
...
Хроматография липидов на пропитанной адсорбентом фильтровальной бумаге имеет ряд преимуществ перед другими способами адсорбционной хроматографии. По сравнению с бумагой из стеклянных волокон целлюлозная бумага дешевле и удобнее в обращении [687]. Поскольку тонкослойная хроматография отличается более высокой эффективностью, отдельный класс липидов может давать более чем одно пятно. Это обстоятельство затрудняет разделение смесей неизвестного состава [833]. Адсорбционная хроматография на бумаге, в отличие от тонкослойной хроматографии, обычно не дает пятен с «хвостами», обеспечивает большую воспроизводимость величины $R_f$ и не вносит ошибки, связанной с препаративным выделением вещества с пластинки вместе со слоем адсорбента [427]. В настоящее время этот метод довольно широко применяется для разделения липидов.
...
В 1948 г. Рамсай и Паттерсон предложили использовать силикагель в качестве носителя для распределительной хроматографии жирных кислот. Этот метод был стандартизирован с $С¹⁴$-кислотами и неоднократно применялся для разделения липидов. Силикагель с этой целью суспендируют в нижней фазе системы и под давлением заполняют колонку. Пробу (3,3—3,8 мг липидов на 1 г носителя) растворяют в верхней фазе и вносят в колонку. Растворитель (верхнюю фазу) пропускают со скоростью 0,6—1,2 мл/мин [186, 253, 274, 570, 649, 650, 754, 809, 1013]. Кислоты разделяли в системах 1: фурфуриловый спирт: 2-аминопиридин = 1:1/гексан, 0,25 н. раствор $NH₄OH$ в $СН₃ОН$/изооктан, 0,2 н. раствор $NH₄OH$ в смеси метилового эфира этиленгликоля и воды 9: 1/гексан, 0,3 н. раствор $NaOH$ в $СН₃ОН$/циклогексан. Таким образом, жирные кислоты двигались по колонке в виде солей [274]. Для разделения оксикислот использовали системы: 0,1 н. раствор $NH₄OH$ в 95% $СН₃ОН$/петролейный эфир или $СН₃ОН$: гексан: ацетон = 2: 10: 1, а для дикарбоновых кислот — продуктов окислительного расщепления липидов по двойным связям — системы 0,2 н. раствор $NH₄OH$ в смеси метилового эфира этиленгликоля и воды 9: 1/смесь гексана и дибутилового эфира 1:1, 1 М раствор цитрата натрия, рН 5,4/$CHCl₃$-бутанол или $СН₃ОН$: вода: гексан: ацетон = 7,7: 1,9: 77:34 [173, 188, 241]. Продукты окисления триглицеридов смесью $KMnO₄-КJO₄$ разделяли в системе 90%-ный этанол: петролейный эфир. Сложные эфиры кислот фракционировали в системах: нитрометан: петролейный эфир или 2-феноксиэтанол: гептан [254, 1008]. Время анализа на колонках с силикагелем достигало 20 час. Для количественного определения отдельные фракции элюата титровали 0,05 н. раствором $NaOH$ с фенолфталеином или феноловым красным. В элюате содержалось 95—105% исходных липидов. Силикагель можно пропитать индикатором до разделения; в этом случае кислоты мигрируют в виде окрашенных полос. Производные жирных кислот образуют окрашенные зоны на колонке и при отсутствии индикаторов [1013].

Липиды выходили из колонки в порядке возрастания полярности. «Четные» насыщенные одно- и двухосновные кислоты с $m = 10—22$ хорошо разделялись между собой; для разделения дикарбоновых кислот с $m = 6—10$ было достаточно различия на $СН₂$-группу. Рицинолевая и диоксистеариновая кислоты отделялись друг от друга и от остальных кислот [173, 188]. Продукты окисления глицеридов делились на фракции SSS + SSAz и SAzAz + AzAzAz, где S и Az — ацилы насыщенных кислот и азелаиновой кислоты (стр. 170) [1008]. В ряду _п_-фенилазофенациловых эфиров насыщенных кислот с $m = 2—18$ и 2,4-динитрофенилгидразонов (2,4-ДНФГ) этих эфиров полностью разделялись гомологи, различающиеся на $СН₂$-группу. На колонке, приготовленной по методу Рамсая, было достигнуто фракционирование гомологического ряда 2,4-ДНФГ алифатических альдегидов с $m = 2—18$

#footnote[Неподвижная фаза/подвижная фаза.]

#pagebreak() // 9

[254]. Согласно основному уравнению Мартина для распределительной хроматографии, логарифм удерживаемого объема $V_R$ этих соединений в колонке находился в линейной зависимости от длины цепи. Эта закономерность была использована для идентификации липидов [252].
...
Большую роль в разработке современной обращенно-фазовой хроматографии сыграл созданный ранее нехроматографический метод противоточного распределения, основанный на непрерывном автоматическом фракционировании смеси липидов в подвижной двухфазной системе растворителей. После уравновешивания концентраций разделяемых веществ в верхней и нижней фазах первой пробирки автомата верхняя фаза передается во вторую пробирку, содержащую только нижнюю фазу; там снова достигается уравновешивание концентраций, и этот процесс повторяется еще многократно. Вследствие разной величины коэффициента распределения _α_ отдельных компонентов, в противоточной системе они разделяются на фракции различной полярности. Содержание вещества во фракциях описывается отдельными членами разложения бинома Ньютона ${[1/(α + 1)] + [α/(α + 1)]}^n$, а концентрация в _r_-й пробирке после _n_ переносов $T_(n,r) = {n!/[r!(n-r)!]} [1/(α + 1)]^n × α^r$ [689].

Разделение в обращенно-фазовых распределительных системах, как и в противоточных, происходит согласно величине _α_, но отличается меньшей величиной требуемой пробы и большей эффективностью. Метод распределительной хроматографии, который может применяться в виде хроматографии на бумаге, на колонке и в тонком слое, незаменим для фракционирования полиненасыщенных триглицеридов с $e > 6$, поскольку использование адсорбционной тонкослойной хроматографии комплексов с ионами $Ag⁺$ не обеспечивает достаточной четкости разделения этих глицеридов. Величина _α_ в обращенно-фазовой системе определяется полярностью веществ, зависящей в пределах данного класса от числа «эффективных метиленовых групп» алифатического радикала, соединенных между собой простыми _σ_-связями. Другими словами, появление двойной связи в ацильном остатке (на достаточном удалении от концов цепи) и укорочение алифатического радикала на две $СН₂$-группы обычно в одинаковой степени увеличивают полярность липида, которую можно выразить константой полярности $К = 100^(m-2e)$ или предложенным позднее «числом распределения» $PN = m - 2e$. Величины _К_ и _PN_ можно вычислить для каждого вида триглицерида. Триглицериды одинаковой полярности равны по значению _α_ и в совокупности образуют «группу полярности», дающую одну зону смешанного состава при обращенно-фазовом разделении. Глицериды группы полярности с наименьшим значением _PN_ элюируются из обращенно-фазовой системы в первую очередь, а с наибольшим — в последнюю. Поскольку положение двойных связей не влияет на _α_, можно, исходя из видового состава кислот в отдельных видах триглицеридов, предсказать хроматографическое поведение последних. Вычисленная величина $PN = m - 2e$ для данной группы полярности должна равняться значению _PN_, найденному из жирнокислотного состава этой группы после ее элюирования: $PN = 3[(PN)₁×p₁+(PN)₂×p₂+...+(PN)ₙ×pₙ]/100$, где $p₁, p₂, ..., pₙ$ — содержание жирных кислот в триглицеридах данной группы полярности в мол. %. Величины $(PN)₁, (PN)₂, ... (PN)ₙ$ для отдельных видов кислот были равны $m - 2e$. Вычисленные и найденные величины _PN_ триглицеридов масла эфедры почти полностью совпадали [635].

#pagebreak() // 10

===== Экспериментальное И Теоретическое Исследование Обращенно Фазовой Хроматографической Системы

Для экспериментального определения значения _α_ жирных кислот в системе водный ацетон: парафиновое масло 2 мг кислоты растворяли в 0,5 мл неполярной фазы, смешивали с 0,5 г носителя (кизельгура) и прибавляли 5 мл водного ацетона. Систему уравновешивали несколько минут при 35°, центрифугировали и пробы верхней фазы по 2 мл оттитровывали _А_ мл 0,001 н. КОН в $СН₃ОН$. К остатку прибавляли 5 мл 95% ацетона, который полностью элюирует кислоты из неполярной фазы, и пробы по 2 мл титровали _Р_ мл щелочи. Величину _α_ (соотношение концентраций кислоты в подвижной и неподвижной фазах) вычисляли по формуле $α = AV/(6P - А)$, где _V_ — объем неполярной фазы. Точность определения (Т в %), которую находили по уравнению $Т = 100NE (2A+3P)/W$, где _N_ — нормальность щелочи, _W_ и _Е_ — соответственно вес и эквивалент кислоты, обычно составляла ± 5%. Откладывая в системе координат величину $lg 100 α$ для различных жирных кислот в зависимости от концентрации ацетона в растворителе, получали семейство параллельных прямых. Для кислот одинаковой полярности эти прямые совпадали между собой. Оптимальные условия разделения обеспечиваются при такой концентрации растворителя, когда _α_ данной кислоты равен 0,16, а значение _α_ следующего высшего гомолога 0,08 [324].

Для математического описания обращенно-фазовой системы разделения пальмитиновой и стеариновой кислот рассматривалась колонка, содержащая _р_ тарелок. Считая, что каждая тарелка действует подобно делительной воронке в процессе противоточного распределения, количество растворенного вещества $Т_(p+a)$, определяли по формуле, приведенной на стр. 47. После _р_ переносов фронт растворителя достигает последней _р_-й тарелки, а затем известное количество растворенного вещества $E_(a+1)$ выходит из колонки с (_a_ + 1)-й фракцией элюата (каждая фракция элюата имеет тот же объем, что и объем подвижной фазы в теоретической тарелке обращенно-фазовой хроматографической системы):
$E_(a+1) = ((p+a)!)/(p! a!) × (α')^a / (α' + 1)^(p+a+1) = a/(p+a) × (α')/(α' + 1) × E_a$ (1)
где: _a_ — номер фракции элюата; $E_a$ — количество растворенного вещества в элюате _a_; _α'_ — коэффициент распределения жирной кислоты в условиях хроматографического разделения.

Фракция растворенного вещества в элюате достигает максимума ($E_макс$) в элюате _f_, когда $α' = p/a$. Отношение _a/p_ эквивалентно общему объема элюата $f × v$, который необходим для достижения максимума, выраженному в объемах подвижной фазы колонки $V_m$:
$f/α' = a/p = f × v/V_m$ (2)

Используя уравнение (2), а также величины положения и высоты каждого пика на экспериментальной выходной кривой, полученной с применением 67%-ного ацетона в качестве растворителя, вычисляли фактический коэффициент распределения _α'_ для пальмитиновой (0,50) и стеариновой кислот (0,22). Разделив величины _α'_ на соотношение между жидкими фазами в колонке (2,5), получали истинные значения коэффициентов распределения _α_, равные соответственно 0,20 и 0,09, что согласуется с найденными экспериментально величинами 0,16 и 0,08.

Из уравнений (1) и (2) можно получить уравнение (3)
$p = 2π (1 + α') (V_макс / (α'v))^2 = 2π/(1 + c) (E_макс / E_c)^2$, (3)
где: _v_ — объем каждого элюата; _c_ — объем подвижной фазы в обращенно-фазовой колонке, выраженный числом фракций элюата в опыте ($c = V_m/v$). Уравнение (3) позволяет вычислить число тарелок _р_ для каждой кислоты по положению и высоте максимума элюата на выходной кривой. Для пальмитиновой и стеариновой кислот величина _р_ равнялась соответственно 70 и 114. Подставляя вычисленные значения _α'_ и _р_ в уравнение (1), построили теоретическую выходную кривую, которая удовлетворительно совпадала с кривой, полученной по экспериментальным данным.

Процент загрязнения каждого пика веществом соседнего пика (η) определяли по уравнению нормальной кривой ошибки:
$η = 100 (0,5 - A_({x}))$, $x = (V_(AB) - V_B) / (sqrt(V_A) + sqrt(V_B))$
где: $A_({x})$ — площадь нормальной кривой ошибки для аргумента _x_; $A = 1 + 1/α_A$ и $B = 1 + 1/α_B$. Таким образом, для достижения заданной чистоты фракции (η ≤ 0,2%) при отделении кислоты с $α' = 0,50$ в обращенно-фазовой системе с числом теоретических тарелок $p = 100$ от другой кислоты значение _α'_ последней не должно превышать 0,23. Можно видеть, что использованная система обеспечивает практически полное разделение пальмитиновой ($α' = 0,50$) и стеариновой ($α' = 0,22$) кислот [324].
...
В качестве растворителей при разделении липидов обычно применяли водные растворы ацетона, насыщенные неполярной фазой. Для элюирования насыщенных кислот использовали следующие концентрации ацетона (указаны число атомов С и концентрации в %) $C₈30, C₈40, C₁₀50, C₁₂53, C₁₄58-60, C₁₆ 65-67, C₁₈ 70-73, C₂₀ 75-78, C₂₂80-83, C₂₄ 85-90$ [402]. Растворитель для разделения триглицеридов кокосового масла состоял из смеси ацетона, гептана и воды [103], а для глицеридов масла льна представлял собой 95%-ный ацетон [375]. Повышение концентрации воды увеличивает $V_R$ и эффективность колонки [103]. Для разделения кислот и их производных применяли также смесь $СН₃ОН$ с ацетоном 3:1 [112], 65—100% $CH₃OH$ [949], 40—70% этанола [574], смесь ацетонитрила с $СН₃ОН$ 17:3 [802] и смесь $CH₃COOH$, $НСООН$ и воды = 2:2:1 [336]. Кислоты и их метиловые эфиры разделяли в системе ацетонитрил: вода = 3:1 [295]. Применение водного этанола для фракционирования 2-моно- и 1,2(2,3)-диглицеридов приводило к их превращению в устойчивые 1(3)-моно- и 1,3-ди-изомеры; в водном ацетоне миграцию ацилов не наблюдали [847].

Насыщенные жирные кислоты, отличающиеся друг от друга на $СН₂$-группу, хорошо разделяются и выходят из колонки в порядке уменьшения константы _К_ [402]. Разветвленная лактобацилловая кислота (11, 12-метиленоктадекановая кислота) по величине $R_f$ совпадала со стеариновой кислотой [382]. Ненасыщенные кислоты разделяются между собой, но не отделяются от насыщенных кислот с тем же значением _К_ [326].
...
Окси-, эпокси- и кетокислоты благодаря высокой полярности хорошо отделяются от обычных кислот и могут разделяться между собой как в незамещенном виде, так и в виде ацетатов на колонках с ацетилированным касторовым маслом. Оксистеариновая кислота по величине $V_R$ совпадала с лауриновой кислотой [326]. Хлорфенациловые эфиры разделялись подобно незамещенным кислотам [574]. На колонках с парафиновым маслом разделялись моно-, ди- и триглицериды, а также триглицериды, различающиеся между собой на четыре $СН₂$-группы или на две двойные связи; глицериды, отличающиеся на две $СН₂$-группы или на двойную связь, разделялись не полностью [103]. На колонке фактиса метиловые эфиры, эфиры холестерина и триглицериды разделялись на фракции с одинаковой _К_; величины $lg V_R$ находились в линейной зависимости от числа атомов углерода в этих соединениях [375].
...
Жирные кислоты $C₁₀-₁₈$ (0,5—20 мкг) разделяли смесью $CH₃COOH: CH₃CN$ (1: 1) или 85%-ной $СН₃СООН$ в течение часа. Для разделения кислот с одинаковой константой _К_ в полярную фазу прибавляли 0,5% брома: присоединение брома по двойным связям ненасыщенных кислот значительно повышало их подвижность [524]. Липиды одинаковой полярности можно разделить и после гидрирования: кислоты на пластинке опрыскивают 1—2%-ной суспензией палладия, гидрируют $Н₂$ в эксикаторе, промывают 5%-ной $HCl$ и разделяют после пропитывания пластинки ундеканом [554]. Насыщенные кислоты с $m=18—34$ разделяли в системе изопропанол: этанол: $СН₃СООН$: вода (8:3:4:1, 3)/тетрадекан при 42° и определяли количественно с ацетатом Cu (стр. 58) [514]. С 80%-ной $СН₃СООН$ разделили $C₁₃-₂₅$-2-метил-4-кетокислоты и $C₁₂-₂₂$-оксикислоты [527]. Растворителями для $C₁₂-₃₄$-жирных спиртов служили 85%-ная $СН₃СООН$ или 90%-ный ацетон [555].
...
Жирные кислоты и другие кислые липиды легче всего определить неспецифической реакцией с индикаторами: 0,2—0,4%-ным бромтимоловым синим в спирте, рН 8—8,3, бромфеноловым синим или бромкрезоловым зеленым, 0,05%-ным крезоловым красным и крезолфталеином в 0,8%-ном $NaOH$, малахитовым зеленым, нильским голубым, тимолфталеином и феноловым красным. С пирогаллоловым красным наименьшее количество липида, которое можно визуально определить на распределительной хроматограмме $z = 15$ мкг [190, 429, 602, 603, 605]. Данные титрования кислот 0,005 н. $NaOH$ по бромтимоловому синему после их экстрагирования с бумаги совпадали с результатами роданометрического определения [429, 681].
...
Обращенно-фазовые системы почти не применяются для фракционирования смеси липидов на классы: различия в полярности столь велики, что разделение в какой-либо одной системе становится невозможным. Кроме того, липиды различных классов, характеризуемые разными значениями _К_, часто совпадают по величине $R_f$. Так, олеиловый спирт не отделяется от миристиновой кислоты, а диглицериды накладываются на зону стеариновой кислоты [387]. Для сопоставления классов по абсолютной величине полярности ввели понятие «всеобщей» константы полярности — $К_вс$. Системой отсчета служил гомологический ряд эфиров одноатомных спиртов и «четных» _н_-жирных кислот: значения $К_вс$ и _К_ у них совпадали. Для липидов другого гомологического ряда $К_вс$ равна величине _К_ того вещества системы отсчета, которое имеет одинаковое с этим липидом значение $R_f$. Инкремент _i_, т. е. разность между $К_вс$ и _К_ данного липида, постоянен для определенного ряда. Аддитивная величина _i_ зависит от числа $СН₂$-, СООН, ОН-групп, двойных или сложноэфирных связей, положения функциональных групп и других факторов. Для триглицеридов значение _i_ равно 14, для сложных эфиров ненасыщенных кислот — 12, для 2-оксикислот — 10, для сложных эфиров ароматических спиртов — 2 и т. д. Такая абсолютная шкала полярности весьма полезна для идентификации липидов по их принадлежности к конкретному гомологическому ряду [518].

Как видно, подвижность липидов при разделении зависит от их состава. Связь величины $R_f$ в различных системах [92, 232, 584] с параметрами молекулы насыщенных жирных кислот выражали эмпирическими уравнениями:
$R_f = 1,671-0,1326m+0,0028m²$; $R_f = 1,42+(-0,062)m$;
$R_f = 1,50-0,00625m$,
а для ненасыщенных кислот — уравнениями:
$R_f = 1,42-(-0,062) (m-2)$; $R_f = 1,57 -0,06m$.

Зависимость значений $R_f$ от _m_ жирных кислот или их _п_-фенилазофенациловых эфиров была линейной [532]. Для триглицеридов такой зависимости не обнаружили [534]. Величина $R_f$ ненасыщенных кислот с $m = 18$ была линейной функцией числа двойных связей в цепи [430].
...
#table(
  ...
  [120х0,4], [Стеклянные шарики, 0,75—1 мм], [Полиэтиленгликоль-сукцинат (1%) + $H₃PO₄$ (0,4%)], [140—200],
)
...
#table(
  ...
  [Аргон], [35—50], [_β_-Ионизационный], [$C₄-C₁₈$], [90], [[912]],
  [»], [60], [»], [$C₈-C₁₈$], [40], [[461]],
)
...
#align(center)[
  #strong[Условия анализа метиловых эфиров жирных кислот методом газо-жидкостной хроматографии]
]

#table(
  columns: (auto, auto, auto, auto),
  stroke: 0.4pt,
  [*Размеры колонки, см*], [*Твердый носитель*], [*Жидкая фаза и ее содержание в наполнителе*], [*Температура, °C*], [*Газ-носитель*],
  [91,4х0,63], [Стерхамол 52—85 меш], [DC-Силикон], [210], [Азот],
  [110х0,4], [Целит-545, 50—100 меш], [Апьезон L, 10—20%], [197—231], [»],
  [122х0,4], [Целит-545, 100—210 меш], [Апьезон L, 20%], [197], [Аргон],
  [122х0,4], [Целит-545, 100—210 меш], [Полиэтиленгликольадипат, 24%], [180], [»],
  [120х0,4], [Целит-545, 140—170 меш], [Полиэтиленгликольсукцинат, 20%], [203], [Гелий],
  [3050х0,025 (капиллярная)], [], [Апьезон L], [200], [Аргон],
  [То же], [], [Диэтиленгликольсукцинат], [168—188], [»],
)
...
#table(
  columns: (auto, auto, auto, auto),
  stroke: 0.4pt,
  [*Расход газа, мл/мин*], [*Детектор*], [*Состав кислот в пробе*], [*Время анализа, мин.*], [*Литературный источник*],
  [5,5], [Катарометр], [$C₁₈-C₃₄$], [150], [[573]],
  [20—30], [»], [$C₁₂-C₂₈$], [80—180], [[93]],
  [60], [_β_-Ионизационный], [$C₁₂ - C₂₈$], [72], [[434]],
  [40], [»], [$C₁₂-C₁₈$], [70], [[434]],
  [200], [Катарометр], [$C₁₀-C₂₀$], [38], [[631]],
  [0,5—1], [_β_-Ионизационный], [Цис-, транс- изомеры 18:2 и 18:3], [60], [[644]],
  [0,5—1], [»], [То же], [40], [[644]],
)
...
#table(
  ...
  [0,8 н. $HCl$], [2], [64—65], [»], [], [[434]],
  [5% HCl], [2], [80—100], [»], [95], [[909]],
  [5% $H₂SO₄$], [18], [64—65], [»], [], [[940]],
  [0,005% Na], [0,5], [], [»], [96], [[223]],
  [0,1 н. Na или К], [1,5—2], [64—65], [Азот], [98], [[657]],
  [1% Na], [2 мин.], [60], [»], [99], [[291]],
)

Недостаток этого метода состоит в том, что диазометан ядовит и взрывоопасен. Кроме того, он может давать артефакты — продукты присоединения $CH₂N₂$ к двойным связям жирных кислот [909]. В последнее время было обнаружено, что свежеприготовленный раствор $CH₂N₂$ в смеси $СН₃ОН$ и эфира 1: 9 позволяет получать метиловые эфиры за 10 мин. с количественным выходом и без примеси продуктов разрушения или полимеризации. По-видимому, метанол играет в данной реакции роль катализатора [851]. В другой работе рекомендуется синтезировать эфиры, выдерживая жирные кислоты в слабом растворе диазометана при −34° в течение двух с половиной дней [101]. Этерификация жирных кислот в растворе трехфтористого бора в метаноле заканчивается всего за 2 мин., но выход метиловых эфиров не превышает 90—95%; эпоксикислоты и кислоты с сопряженными двойными связями не могут быть этерифицированы этим методом [718]. Активность $CH₂N₂$, $HCl$ и $BF₃$ в реакции образования эфиров высших жирных кислот приблизительно одинакова [412, 693]. Наиболее удобным методом получения метиловых эфиров, обеспечивающим количественный выход эфиров независимо от жирнокислотного состава масла, можно считать омыление жира с последующей этерификацией возникших в этой реакции жирных кислот метанолом в присутствии хлористого водорода. Для получения количественного выхода более летучих эфиров низших кислот $C₁-C₁₀$ следует применять диазометан [693] и использовать докозан в качестве растворителя [539] или же вместо метиловых эфиров получать этиловые эфиры [62].
...
Температура колонки оказывает значительное влияние на удерживаемый объем отдельных компонентов. Так, на полиэфирной колонке метилстеарат не отделяется от метилолеата при 125°, но хорошо отделяется при 158—168° [632]. «Фактор разделения» — отношение удерживаемого объема $V_R$ данного компонента смеси к $V_R$ предыдущего гомолога #footnote[В отечественной литературе это понятие обозначают «относительная летучесть».] [437] — для эфиров насыщенных кислот и кислот с разветвленной цепью с повышением рабочей температуры обычно снижается, а для ненасыщенных эфиров (по отношению к предшествующим насыщенным эфирам с той же длиной цепи) — возрастает [614]. Эту закономерность можно использовать для хроматографической идентификации жирных кислот. При разделении смеси метиловых эфиров на полярной колонке без предварительной калибровки катарометра повышение температуры приводило к завышенным результатам для легколетучих компонентов и заниженным значениям для эфиров с большим временем удерживания. С падением температуры анализа ошибка определения снижалась [631, 765] (стр. 85).
...
На колонках _β_-циклодекстрин-валерата, -бутирата, -пропионата и -ацетата разделены девять разветвленных метил-, диметил- и триметилизомеров метилгептадаканоата [653].

Ненасыщенные эфиры с одинаковым числом атомов углерода и двойных связей, различающиеся по расположению связей в цепи, плохо делятся на насадочной колонке, но могут быть разделены при использовании капиллярной колонки. Так, 8,11-, 9,12-, 10,13- и 11,14-изомеры метиллинолеата на капиллярной колонке полиэтиленгликольглутарата полностью отделялись друг от друга и от метиловых эфиров стеариновой, олеиновой и линоленовой кислот; на обычной колонке с полиэтиленгликольадипатом происходило лишь разделение 11,14-изомера и суммы 8,11- + 9,12-изомеров. При удалении двойной связи от карбоксила величина $V_R$ несколько возрастала, но метиловые эфиры олеиновой и петрозелиновой кислот на обеих колонках не могли быть разделены [613]. Метиловые эфиры линоленовой и линолевой кислот с сопряженными двойными связями хорошо отделялись от соответствующих эфиров с изолированными связями [235].

На заполненной сорбентом колонке цис,транс-изомеры ненасыщенных кислот не разделяются [498, 632]. На капиллярной колонке с полиэтиленсукцинатом удалось отделить метилолеат от метилэлаидата, у которого величина $V_R$ была меньше. Геометрические изомеры метиллинолеата разделены на транс, транс-, цис, цис- + цис, транс- и транс, цис-формы, а изомеры метиллинолената — на транс, транс, транс-, моно-транс-, ди-транс-, цис, цис, цис- + ди-транс- и моно-транс- + моно-цис- формы. Разделение геометрических изомеров метиллинолеата с сопряженными двойными связями было столь же эффективным, как и на неполярной колонке [644].

Описана хроматография метил-цис-9,10-эпоксиоктадеканоата и его производных на полиэфирной колонке [944]. На колонке с полиэфиром сукцината разделены метиловые эфиры эритро- и трео-дибромоктадекановых кислот, из которых трео-формы с большим дипольным моментом обнаруживали более высокое значение удерживаемого объема. Величина $V_R$ трео-формы в 20 раз превышала значение $V_R$ метилстеарата [894].
...
Величины удерживаемых объемов $V_R$ метиловых эфиров жирных кислот в значительной степени зависят от параметров разделения; в целях идентификации отдельные компоненты смеси обычно характеризуют численным значением относительного удерживаемого объема $V_R^(отн)$, которое равно отношению $V_R$ данного эфира к $V_R$ известного вещества (метилового эфира миристиновой, пальмитиновой или стеариновой кислот [765]). Величину $V_R$ измеряют от вершины пика газа, не адсорбируемого при данных условиях разделения (на практике при анализе эфиров высших жирных кислот таким газом обычно служит воздух) [422]. Наиболее простой метод хроматографической идентификации — это идентификация по величине $V_R^(отн)$; однако ввиду возможного содержания в одной хроматографической полосе двух или нескольких различных компонентов такая идентификация при анализе сложных смесей жирных кислот иногда оказывается недостаточно надежной [540]. Идентификация разветвленных и ненасыщенных кислот по величине фактора разделения описана на стр. 72.

Газохроматографическое разделение липидов, как и всякий процесс распределительной хроматографии, подчиняется правилу аддитивности [437, 690, 968]. Согласно этому правилу, прибавление новой функциональной группировки в цепи изменяет величину коэффициента распределения вещества только соответственно природе этой группировки и ее распределению в фазах хроматографической системы, но независимо от состава остальной части молекулы. Поэтому на неполярных и полярных фазах для гомологических рядов метиловых эфиров насыщенных _н_-жирных кислот [765], разветвленных насыщенных кислот, изо- и (+-)-антеизо-разветвленных кислот [354], мононенасыщенных кислот [354, 765], ди-, три- и полиненасыщенных кислот [434], бромированных жирных кислот [894], моно- и дикарбоновых кислот с короткой цепью [439] и других липидов [306, 595, 706] в системе координат $lg V_R^(отн)$ — число атомов углерода в алифатической цепи (_m_) получается семейство прямых, которые в диапазоне $C_8 - C_26$ практически параллельны между собой. Для метиловых эфиров с одинаковой длиной цепи установлена линейная зависимость между $lg V_R^(отн)$ и числом двойных связей [765]. Функциональная зависимость для жирных кислот описывается уравнением вида $lg V_R^(отн) = a+bm$, где _a_ и _b_ — константы, зависящие от параметров опыта [229, 573]. При увеличении температуры разделения тангенсы углов наклона между параллельными прямыми и осью абсцисс уменьшаются [730]. Жирные кислоты, принадлежащие к известному гомологическому ряду, можно идентифицировать, используя линейную зависимость между $lg V_R^(отн)$ и _m_.

Если гомологическая принадлежность неизвестна, то метиловый эфир идентифицируют по величине $V_R^(отн)$ на колонках с неполярной и полярной жидкими фазами на основе закономерности, обнаруженной Джеймсом для _н_-насыщенных кислот и _н_-ненасыщенных кислот с изолированными двойными связями. Джеймс показал, что между отложенными на осях координат величинами $lg V_R^(отн)$ метиловых эфиров данного гомологического ряда на колонках с апьезоном L, с одной стороны, и на колонках с полиэтиленгликольадипатом — с другой, существует линейная зависимость, причем насыщенные, моно-, ди-, три- и полиненасыщенные жирные кислоты образуют ряд параллельных прямых. Положение точки, в которой линия, проведенная параллельно оси абсцисс или оси ординат из найденного для данной кислоты значения $lg V_R^(отн)$, пересекается с той или иной из этих прямых, позволяет характеризовать неизвестную кислоту по числу атомов углерода и двойных связей. Точки пересечения, соответствующие эфирам с одинаковой длиной цепи, но различающимся по ненасыщенности, лежат вдоль перпендикуляра, который проведен к прямой для эфиров насыщенных кислот в точке, соответствующей метиловому эфиру насыщенной жирной кислоты с данным числом атомов углерода [434]. Аналогичные закономерности получены при разделении смеси жирных кислот на двух полиэфирных колонках различной полярности [853].

Вместо $V_R^(отн)$ для идентификации жирных кислот можно использовать другую относительную величину, которая получила название «углеродного числа» [997] или «эквивалентной длины цепи» (ЭДЦ) [731]. Для нахождения ЭДЦ неидентифицированного пика хроматограммы строят эталонную прямую зависимости $lg V_R^(отн)$ метиловых эфиров нормальных насыщенных жирных кислот от числа атомов углерода _m_ для данных условий разделения, а затем по этой прямой определяют величину _m_, соответствующую найденному значению $lg V_R^(отн)$ идентифицируемого компонента; полученная величина _m_ и является ЭДЦ данного метилового эфира. При отсутствии эталонной прямой ЭДЦ можно вычислить из уравнения $ЭДЦ = (s₂-s₁) lg (t_x: t_(s₁)): lg (t_(s₂): t_(s₁)) + s₁$, где $s₁$ и $s₂$ — ЭДЦ стандартных метиловых эфиров; $t_x, t_(s₁)$ и $t_(s₂)$ — $V_R^(отн)$ исследуемого эфира и стандартов [730]. Очевидно, что для насыщенных эфиров величины ЭДЦ на полярных и неполярных фазах совпадают и равны числу атомов углерода в алифатической цепи. Включение двойной связи или определенной функциональной группы в молекулу дает известный инкремент ЭДЦ по сравнению с ЭДЦ насыщенного эфира с той же длиной цепи, характеризующий данную связь или группу. Величины инкрементов ЭДЦ для некоторых заместителей приведены в табл. 7. С помощью ЭДЦ неизвестного компонента на колонках с неполярной и полярной жидкими фазами можно идентифицировать данный компонент и входящие в его состав функциональные группы. Величины ЭДЦ были использованы для идентификации девяти изомеров разветвленных жирных кислот с $m = 17$ на полярных фазах — ацилированных _β_-циклодекстринах [296].

#align(center)[
  #strong[Таблица 7] \
  #strong[Величины инкрементов эквивалентной длины цепи для различных функциональных групп при газо-жидкостной хроматографии метиловых эфиров жирных кислот на неполярных и полярных жидких фазах]
]
...
В последнее время разработаны методы, позволяющие определить не только число (_e_), но и расположение изолированных двойных связей в цепи жирных кислот по величине $V_R^(отн)$ на жидких фазах, обладающих высокой полярностью [47, 49, 50]. Значение $V_R^(отн)$ на полиэфирных фазах при «смещении» двойных связей из центрального положения к карбоксильному или метильному концу алифатической цепи возрастает. Откладывая в системе координат величины $lg V_R^(отн)$ метиловых эфиров ненасыщенных кислот против числа атомов углерода (см. выше), заметили, что это возрастание носит закономерный характер. Оно происходит таким образом, что прямые между точками, полученными в системе координат и соответствующими гомологическому ряду ненасыщенных эфиров с одинаковым числом несопряженных двойных связей, будут параллельны между собой лишь при определенном условии. Параллельность будет наблюдаться только в том случае, когда при возрастании длины цепи в каждом гомологическом ряду число атомов углерода от центра двойной связи, наиболее удаленной от карбоксильной группы, до концевой метильной группы включительно остается одинаковым. Иными словами, прямые будут параллельны лишь при условии, что наращивание метиленовых групп в каждом гомологическом ряду ненасыщенных эфиров идет только с карбоксильного конца цепи [47]. Аналогичные ряды параллельных прямых получены группированием ненасыщенных жирных кислот с одинаковым числом атомов углерода между центром ближайшей к карбоксилу двойной связи и СООН-группой, а также кислот одинаковой ненасыщенности с равным числом атомов углерода, у которых двойные связи регулярно смещаются от карбоксильного конца алифатической цепи к метильному [49]. Сравнивая при помощи таких графиков найденные величины $lg V_R^(отн)$ со значениями $lg V_R^(отн)$ эфиров с известным расположением двойных связей, определили строение полиненасыщенных кислот китового жира [50].
...
Наиболее достоверные данные для установления структуры ненасыщенных кислот получены методом восстановительного озонолиза. Образовавшиеся при низкой температуре озониды разлагают $H₂$ в присутствии Pd-катализатора или путем восстановления трифенилфосфином; при этом в местах разрыва двойных связей возникают альдегидные группы. Газо-жидкостную хроматографию альдегидов и диальдегидов проводят на приборе с пламенно-ионизационным детектором, так как малоновый диальдегид плохо обнаруживается _β_-ионизационным детектором [799, 801, 895].
...
В настоящее время для количественного определения метиловых эфиров используют в основном три вида газохроматографических детекторов — катарометр, аргоновый (_β_-ионизационный) и пламенно-ионизационный.
...
В результате подробного исследования стандартных смесей метиловых эфиров известного состава было установлено, что в гомологическом ряду жирных кислот отсутствует пропорциональность между молекулярным весом и удельной теплопроводностью. Так, если площадь пика, приходящуюся на 1 мг вещества, для метилкаприната принять за 1,00, то для метилстеарата эта величина составит только 0,84 [575]. Были предложены следующие эмпирические уравнения для внесения поправки на теплопроводность: $lg A = m × lg M + lg К$, где А — площадь пика, М — вес вещества, _m_ — число атомов углерода и К — константа [887]; $R = 24,68 + 5,79 m + 0,075 m²$, где R — относительный молярный сигнал детектора по отношению к сигналу для метилпальмитата [400]; $lg y = 0,001007 х — 0,161$, где _y_ — поправочный фактор, _х_ — относительный удерживаемый объем [260]. В работе Кауфмана обнаружена линейная зависимость между величиной калибровочного фактора (отношения весового содержания метилового эфира к площади пика) и числом атомов углерода в данном гомологическом ряду жирных кислот [550].
...
В 1958 г. Лавлок предложил новый тип детектора [653], где органические вещества обнаруживаются и количественно определяются за счет их ионизации метастабильными атомами аргона. Эти атомы, возникающие при облучении проходящего через детектор аргона _β_-частицами стронция-90, имеют потенциал возбуждения (11,6 eV), который выше потенциала ионизации большинства органических веществ. Ионизация органических веществ приводит к усилению тока ионизации, которое регистрируется самописцем прибора. Высокая чувствительность ионизационного детектора ($10⁻⁹$ г) позволяет применять для разделения малые количества веществ, что значительно увеличивает эффективность разделения. Для эфиров с молекулярным весом 150 и выше площадь пика пропорциональна массе метилового эфира, поэтому детектор обычно не требует калибровки [412, 632, 654].
...
Несмотря на перечисленные осложняющие обстоятельства, _β_-ионизационный детектор, благодаря высокой чувствительности, простоте и надежности в работе, широко используется при количественном определении метиловых эфиров высших жирных кислот.
...
Работы по газохроматографическому разделению триглицеридов начали появляться с 1960 г. [284, 411, 595]. До сих пор газо-жидкостная хроматография применялась для определения углеродного состава триглицеридов сливочного масла и его молекулярных дистиллятов (рис. 3) [592, 597]; свиного жира [279]; жировой ткани крысы [639]; пяти гидрированных рыбьих жиров [351]; пальмоядрового и кокосового масел; масел 17 видов растений из сем. Lauraceae, Lythraceae и Ulmaceae [641]; масел диких тропических растений _Cuphea miniata_, _Myrica carolinensis_ и _Virola surinamensis_, богатых насыщенными кислотами с $m = 8—14$ [233, 350, 638]; масла какао [639]; масел рапса и других растений из сем. Cruciferae и Tropaeolaceae, богатых эруковой кислотой [351]; масел арахиса, хлопчатника, кунжута, сафлора и сои, оливкового масла, масел _Acanthsyris spinescens_ и _Hydnocarpus wightiana_ и других природных жиров [273, 279].
...
#figure(
  ...
  caption: [
    ...
    _a_ — исходный дистиллят; _б, в_ — фракции триглицеридов с _e_ = 0 и _e_ = 1 соответственно, выделенные тонкослойной хроматографией комплексов триглицеридов с ионами $Ag⁺$. Цифры у пиков — число атомов углерода данной фракции
  ]
)
...
($m = 42$) включительно почти не поглощаются колонкой; с увеличением _m_ с 42 до 56 пропорциональная поглощению величина $f_w$ возрастает. Потеря насыщенных и ненасыщенных высших триглицеридов могла достигать 25—50%, причем для тристеарина и триэруцина эта величина составила 6 и 24% соответственно [639]. В работах лаборатории Куксиса потерю триглицеридов природных жиров характеризовали величиной возврата атомов углерода триглицеридов после газохроматографического разделения $Y = Y_(ex) × 100/Y_t$, где $Y_(ex)$ — найденное число атомов С в 100 молекулах триглицеридов, $Y_t$ — рассчитанное число атомов С в 300 молекулах жирных кислот, которые получены омылением 100 молекул триглицеридов. При расчете учитывали только «четные» жирные кислоты, причем насыщенные и ненасыщенные кислоты с одинаковым _m_ рассматривали как одну кислоту. Если в углеродном составе кислот данного жира содержится _n_ видов кислот с длиной цепи $m₁, m₂, ..., mₙ$ атомов углерода и концентрацией (в мол%) $M₁, M₂, ..., Mₙ$, то $Y_t = 3 [(M₁m₁) + (M₂m₂) + ... +(Mₙmₙ)]$. Если углеродный состав глицеридов того же жира, найденный по данным их газохроматографического определения, насчитывает _n'_ различных фракций (например, $C₅₂, C₅₄$ и т. д.), у которых суммарное количество атомов углерода равно $m'₁, m'₂, ..., m'_(n')$, а концентрация (в мол%) $M'₁, M'₂, ..., M'_(n')$, то $Y_(ex) = M'₁m'₁ + M'₂m'₂ + ... + M'_(n')m'_(n')$. Точность анализа можно также оценить сравнением рассчитанного ($m_t = Y_t/300$) и экспериментально найденного ($m_(ex) = Y_(ex)/300$) среднего числа атомов углерода жирнокислотного остатка триглицерида. Найденные и вычисленные величины для сливочного масла, кокосового масла и других растительных и животных жиров с преобладанием кислот с $m = 8—14$ или с $m = 16—24$ совпадали в пределах 96—100%. Суммирование данных анализа отдельных фракций молекулярного дистиллята молочного жира также привело к результату, в основном отвечающему углеродному составу жира до дистилляции [590, 592—598].

Для определения других категорий состава кроме углеродного состава газо-жидкостную хроматографию триглицеридов необходимо сочетать с другими методами анализа (см. табл. 1) [212, 558, 590]. Так, установление U-видового состава в 5—20 мг жира требует предварительного окисления триглицеридов по Рудлоффу (стр. 45) и этерификации диазометаном СООН-групп образовавшихся моно-, ди- и триазелаотриглицеридов. Окисление хлопкового, оливкового и соевого масел не приводило к гидролизу сложноэфирных групп при остатке глицерина. Метиловые эфиры азелаоглицеридов, имеющие меньший, чем у исходных триглицеридов, молекулярный вес, разделяли на колонке длиной 1,2 м в программированном температурном режиме. При идентификации пиков исходили из того, что по величине инкремента $V_R$ остаток азелаиновой кислоты эквивалентен лаурату. Сочетание разделения азелаоглицеридов с их препаративным выделением и липазным гидролизом позволяет определить позиционно-U-видовой состав триглицеридов. Для расчета мол% азелаоглицеридов площадь каждого пика делили на _m_. После калибровки пламенно-ионизационного детектора с каждым азелаоглицеридом были получены точные количественные данные состава их смеси (± 0,5%). Весь анализ занимает 4 часа. Этот метод особенно применим к жирам, содержащим только жирные кислоты с $m = 16$ и 18, поскольку при газо-жидкостной хроматографии без предварительного окисления эти жиры обычно дают не более 2—3 главных глицеридных пиков. Разделение в виде азелаоглицеридов позволило определить внутри каждого из $S₃$-, $S₂U$- и $SU₂$-типов 14 растительных и животных жиров до 10 различных компонентов, отличающихся разными сочетаниями стеарата и пальмитата. Свиной жир после окисления дал 24 пика (рис. 6) [913, 915, 1010].

Газовая хроматография азелаоглицеридов не обеспечивает разделения триглицеридов с одинаковым _m_, но разным _e_ [606]. Поэтому для определения углеродно-фракционного и видового состава жира требуется сочетание газо-жидкостной хроматографии природных триглицеридов (без окисления) с их предварительным разделением на адсорбенте, пропитанном $AgNO₃$ [248, 318]. Непосредственное определение этих категорий состава газохроматографическими методами невозможно из-за отсутствия достаточно термостойкой полярной жидкой фазы. Каждую из выделенных в тонком слое глицеридных фракций определяли количественно методом внутреннего стандарта, устанавливали ее жирнокислотный состав, а затем элюировали с адсорбента и подвергали препаративному газохроматографическому разделению [639]. В некоторых случаях полученные препараты были достаточно просты для того, чтобы позиционный состав их ацилов можно было определить липазным гидролизом [273, 594]. Однако для большинства природных жиров глицеридный состав внутри выделенных препаратов отличается сложностью. Поэтому даже в сочетании с фракционированием по величине _e_ количественное определение этого состава не представляется возможным, так как число неизвестных величин превышает число независимых уравнений, которые можно составить из данных анализа [558]. В подобных случаях в расчет вводят допущения (стр. 17) [638, 639]. Так, масло _Virola surinamensis_ разделили на 28 компонентов, ни один из которых не был отдельным глицеридным видом. Для расчета видового состава этого масла вычислили все возможные для _e_, _m_ и жирнокислотного состава данного типа триглицериды, затем исключили из расчета триглицериды, содержащие минорные жирные кислоты, и, наконец, установили минимально и максимально возможные величины содержания главных триглицеридов масла [233, 350]. Для предварительного фракционирования триглицеридов применяют также кристаллизацию [212, 590].
...
#figure(
  ...
  caption: [
    ...
    _a_ — исходный жир; _б—е_ — фракции жира с 0,1,2,3 и 4 двойными связями соответственно, полученные хроматографией комплексов триглицеридов с ионами $Ag⁺$. Пики хроматограмм: 1 — $Az₃$; 2 — $ПAz₂$; 3 — $CAz₂$; 4 — $П₂Az$; 5 — $ПCAz$; 6 — $C₂Az + П₃$; 7 — $П₂С$; 8 — $ПС₂$.
  ]
)
...
Для переэтерификации используют жир, не содержащий влаги, жирных кислот и перекисей [298]. Проведение рандомизации без катализатора требует высокой температуры (300°) [517]. Применяют щелочные катализаторы (метилат натрия, бутилат натрия), кислые (например, _β_-нафтилсульфокислота), а также олово и его соединения ($Sn, SnCl₂$ или $Sn (ОН)₂$). Наибольшую скорость реакции обеспечивает метилат натрия. Содержание катализатора в смеси составляет 0,005—1%, а температура процесса 100—200° (в отсутствие растворителя) или 30—60° (при рандомизации в гексане или диметилформамиде) [130, 146, 758]. Статистическую смесь триглицеридов, содержащих остатки высших жирных кислот и уксусной кислоты, можно получить переэтерификацией метиловых эфиров жирных кислот в присутствии триацетина [107]. Переэтерификация смеси масла какао с тристеарином-$C¹⁴$ и $H³$-пальмитиновой кислотой дает смесь равномерно меченых $C¹⁴$- и $H³$-триглицеридов [259]. При высокой температуре полной рандомизации триглицеридов получить не удается; проведение реакции в более мягких условиях приводит к получению чисто статистической глицеридной смеси [598] (число и концентрацию возможных триглицеридов этой смеси см. на стр. 152). По окончании реакции катализатор нейтрализуют, а триглицериды подвергают очистке [174]. На основе правила мультипликаторов Лагранжа можно показать, что для системы из двух жирных кислот А и В максимальная величина $[A₂B]_(RD)$ достигается при $[А] = 2 [B]$: тогда $[А₂В] = 44,4%$, $[A₃] = 29,7%$, $[AB₂] = 22,2% и [В₃] = 3,7%$. Эти закономерности используются в подборе концентраций жирных кислот для синтеза смеси глицеридов нужного состава [82, 689].

Как уже упоминалось, переэтерификация природных жиров приводит к значительным изменениям в свойствах, составе и строении их триглицеридов. Число Бёмера и температура плавления изменяются в зависимости от отклонения [S₃] данного жира от статистического уровня (стр. 102) [298]. Заметные изменения происходят и в фазовой структуре триглицеридов. Так, в быстро застывшем расплаве натурального свиного жира, содержащего 25% 2-ПОС, образуются крупные грубые кристаллы _β'_-3-полиморфной формы этого глицерида (стр. 148), что препятствует использованию этого жира в кондитерском производстве. После переэтерификации благодаря снижению [2-ПОС] до статистического уровня (3,4%) и возникновению легкоплавких $S₂U$-глицеридов «растительного» типа, кристаллизующихся в _β'_-2-форме, зернистость продукта исчезает и эмульгирующая способность жира улучшается (стр. 149) [663, 689]. Изменения свойств жира
...
Для проведения глицеролиза жир выдерживают при высокой температуре в присутствии избытка глицерина и 0,1% $NaOH$ в токе инертного газа. Окончание реакции и установление динамического равновесия миграции ацилов наступает в тот момент, когда реакционная смесь становится растворимой в двух — пяти частях метанола. Константу равновесия реакции глицеролиза $К_e$ рассчитывают по содержанию глицерина, 1(3)- и 2-моноглицеридов (МГ), 1,3- и 1,2 (2,3)-диглицеридов (ДГ) и триглицеридов (ТГ) в продуктах этой реакции. Для анализа применяют адсорбционную хроматографию, периодатное окисление, а также определяют гидроксильное число, кислотное число и число омыления [119, 128, 701]. Полученные данные позволили установить один из кардинальных фактов химии триглицеридов — неравноценность их 1(3)- и 2-оксигрупп в реакциях ацилирования [230, 517, 729]. Действительно, если бы глицеролиз протекал строго статистически и вероятность этерификации первичных и вторичных гидроксилов была одинаковой, то по молярному содержанию этерифицированных (_a_) и неэтерифицированных (_b_) ОН-групп в смеси можно было бы легко вычислить статистические концентрации (RD) три-, ди- и моноглицеридов, а также свободного глицерина, равные $a³ × 10⁻⁴$, $3a²b × 10⁻⁴$, $3ab² × 10⁻⁴$ и $b⁴ × 10⁻³$ соответственно [124, 689]. В случае чисто статистического механизма в положении равновесия $R_pOH + R_sOOCR_1 <=> R_sOH + R_pOOCR_1$, где $R_pОН$ и $R_sОН$ — производные глицерина, содержащие свободную первичную и вторичную гидроксильную группу соответственно, соотношения молярных концентраций позиционных изомеров в моно- и диглицеридах составляли бы $1(3)-МГ]_(RD) = 2 [2-МГ]_(RD)$; $[1,2 (2,3)-ДГ]_(RD) = 2 [1,3-ДГ]_(RD)$, а величина $К_e$, вычисленная по уравнениям $К_e = [1(3)-МГ]_(RD)/2 [2-МГ]_(RD) = [1, 2 (2,3)-ДГ]_(RD)/2 [1,3-ДГ]_(RD)$, была бы равна единице. Однако найденные при обычных условиях глицеролиза (175—180°) равновесные концентрации составили $[1 (3)-МГ] / [2-МГ] = 88: 12$ и $[1,2 (2,3)-ДГ]/[1,3-ДГ] = 40: 60$, а найденная величина $K_e = 3,0 ± 0,6$. Следовательно, величина свободной энергии первичной ОН-группы глицерина в реакции этерификации $ΔF = - RT ln K_e$ выше, чем у вторичной группы приблизительно на 1,2 ккал/моль [124, 125]. Данные о составе равновесной смеси глицеролиза, вычисленные при $К_e = 3, 4$, удовлетворительно совпадают с найденными, а вычисленные при $К_e = 1$ — значительно от них отклоняются (табл. 8) [128]. Увеличение значения _m_ и снижение величины _e_ в ацильном остатке уменьшают скорость ацильной миграции, но не влияют на значение $К_e$ и на соотношение компонентов в равновесной смеси [102]. Замещение одной из первичных ОН-групп не изменяет скорости этерификации другой первичной группы. При снижении температуры реакции величина $К_e$ возрастает [230].

#align(center)[
  #strong[Таблица 8] \
  #strong[Найденный и вычисленный состав равновесной смеси продуктов глицеролиза (в вес. %) [128]]
]
...
#table(
  ...
  [рН среды после добавления 1—6 н. $HCl$], [1—3],
...
#figure(
  image("image.png"),
  caption: [
    Рис. 14. Возможные превращения ПОТП при липазном гидролизе
...
Наглядной моделью мезоатома углерода с четырьмя разными заместителями, помогающей установить стереоконфигурацию данного асимметрического триглицерида согласно (R)/(S) номенклатуре, может служить схематическое изображение рулевого управления автомобиля (рис. 16). В нижней части рис. 16 помещены Фишеровские проекционные формулы двух взятых для примера асимметрических триглицеридов — оптических антиподов _α_-лауродипальмитина (I и II); направление связей между мезоатомом С и заместителями изображено так же, как указано выше. Рассматривая последовательность расположения содержащих ацильные группы заместителей вокруг центра асимметрии (см. верхнюю часть рис. 16), можно заметить, что для (I) заместители в порядке убывания их ранга размещаются против, а для (II) — по часовой стрелке. Следовательно, (I) имеет (S), а (II) — (R) конфигурацию. Согласно (R)/(S) системе, та из карбинольных групп триглицерида, атом водорода которой замещен ацилом более низкого ранга (в данном случае — остатком лауриновой кислоты), обозначается номером 1. Поэтому (I) в (R)/(S) системе следует обозначить как (S)-1-лауродипальмитин, а (II) — как (R)-1-лауродипальмитин [464а, 856].

#figure(
  image("image.png"),
  caption: [
    Рис. 16. Абсолютная конфигурация стереоизомерных _α_-лауродипальмитинов по (R)/(S)-номенклатуре
...
Дальнейшим развитием (R)/(S) системы в применении к пространственной конфигурации глицерина и его производных явилась предложенная Хиршманом система стереоспецифической нумерации с фиксированным положением заместителей (_sn_-система), которая пользуется сейчас наибольшим распространением для обозначения стереоспецифичности триглицеридов и других глицеролипидов [377]. Было условлено, что атомы углерода в проекционной формуле глицерина (Iа), в которой заместитель высшего ранга (гидроксил мезоатома углерода) всегда обращен влево, а атом водорода — вправо, нумеруются так же, как атомы углерода в L-глицериновом альдегиде, т. е. сверху вниз: $2 -> 1 -> 3$. Таким образом, каждая первичная карбинольная группа глицерина получает в _sn_-системе определенный номер, и ей не может присваиваться то

#pagebreak() // 24

номер 1, то 3. Триглицерид обозначается здесь как 1,2,3-триацил-_sn_-глицерин, а D- и L-_α,β_-диглицериды по Беру и Фишеру — как 1,2-диацил- и 2,3-диацил-_sn_-глицерины соответственно [52, 377]. Если имеется равновесная смесь обоих антиподов, что в _sn_-системе она обозначается приставкой _rac_-, например, _rac_-1-олеодипальмитоглицерин, а если конфигурация неизвестна — то приставкой Х, например, Х-1-пальмитодиолеоглицерин. В настоящее время _sn_-система рекомендована ко всеобщему применению Комиссией по биохимической номенклатуре Международного союза по теоретической и прикладной химии для обозначения абсолютной конфигурации липидов [52].
...
По методу Фишера и Бера 1,2,5,6-диизопропилиден-D-маннит (II), полученный из D-маннита (I) обработкой ацетоном в присутствии хлористого цинка, окислительным расщеплением тетраацетатом свинца по 3,4-гидроксильным группам превращают в две молекулы изопропилиден-D-глицеринового альдегида (III), восстанавливают (III) до D-(+)-изопропилиденглицерина (IV), этерифицируют (IV) в 1-положение хлористым ацилом и, удалив остаток ацетона в (V) кислотным гидролизом, получают 3-ацил-_sn_-глицерин (VI). Аналогично из L-маннита синтезируют 1-ацил-_sn_-глицерин [689]. Стереоизомерные моноглицериды превращают в триглицериды (стр. 112).

Для примера показан ход синтеза 1-лауро-2,3-дипальмито-_sn_-глицерина (или (—)-(_S_)-1-лауродипальмитина, I) и 1,2-дипальмито-3-лауро-_sn_-глицерина (или (+)-(_R_)-1-лауродипальмитина, II).
...
Сравнительно более удобным физическим методом определения стереоконфигурации триглицеридов оказался рентгеноструктурный анализ. Поскольку противоположные стереоизомеры (рис. 17, I и II) дают одну и ту же картину дифракции, отличающуюся от картины, даваемой их смесью или синтетическим рацематом (III), для определения конфигурации 2-ОПС из масла какао (рис. 17, IV) сравнивали рентгенограммы III и IV; совпадение этих картин (рис. 17) доказывает, что природный 2-ОПС является рацематом. Если бы это совпадение не обнаружилось, то необходимо было бы получить дифракционную картину смеси природного глицерида с одним из синтетических стереоизомеров, например II; если картина меняется, то стереоизомер IV идентичен II, в противном случае стереоизомер IV идентичен I [856].

===== Качественное Обнаружение Оптической Активности Триглицеридов Химическими Методами

Химические методы анализа стереовидового состава триглицеридов делятся на качественные и количественные. Например, для качественного обнаружения оптической активности в растительных SUU-триглицеридах их можно путем липазного гидролиза превратить в смесь 1,2- и 2,3-диглицеридов; полученные ацетилированием последних ацетотриглицериды можно окислением по двойным связям раствором $КМnО₄-КJO₄$ перевести в смесь VAzS и $УAz₂$-триглицеридов (У — ацетат). Наличие оптического вращения в этой смеси должно свидетельствовать о неэквивалентности жирнокислотного состава в положениях 1 и 3 исходных SUU-глицеридов [212].

Сходный метод анализа предложил Моррис. Поскольку синтетический 1,2-дипальмито-3-сорбо-_sn_-глицерин дал заметную оптическую активность ($[α]⁴⁶_D = +3,7°$), предположили, что, получив соответствующее активное производное _sn_-1,2- и 2,3-диглицеридов — продуктов липазного гидролиза жира, можно поляриметрией этих производных установить присутствие в жире стереоизомеров [212, 738]. ТМС-производные синтетических диглицеридов по величине [α] превосходили как эфиры сорбиновой кислоты, так и сами диглицериды, кроме того, они исключали миграцию ацилов; поэтому такие производные использовали для поляриметрического анализа. Стандартом был синтетический 1,2-дипальмито-3-ТМС-_sn_-глицерин, $[α]_D = +4,7°$. Асимметрические SSO- и SOO-триглицериды расщепляли панкреатической липазой и возникшие _sn_-1,2- и _sn_-2,3-диглицериды превращали в соответствующие ТМС-производные.
...
#align(center)[
  #strong[Таблица 10] \
  #strong[Абсолютная конфигурация SSO- и OOS-триглицеридов некоторых природных жиров]
]
...
#table(
  ...
  [], [], [1,2-], [2,3-], [по _sn_-системе], [по Ингольду],
  [Свиной жир], [SSO], [SS-TMC (+1,6°)], [OS-TMC (−1,3°)], [S-], [(R)],
  [Пальмовое масло], [OOS], [OO-TMC (+2,5°)], [SO-TMC (−2,3°)], [O-], [(S)],
  [Жир _Myristica malabarica_], [OOS], [OO-TMC (+0,5°)], [SO-TMC (−3,9°)], [O-], [(S)],
  [Масло какао], [OOS], [OO-TMC (+1,0°)], [SO-TMC (−3,2°)], [O-], [(S)],
)

Как видно из табл. 10, фракции (+)-_sn_-1,2- и (—)-_sn_-2,3-диглицеридов оптически активны. По абсолютной величине [α] ни одна из фракций не достигала синтетического стандарта. Эти данные позволили предварительно установить абсолютную конфигурацию триглицерида или состав преобладающих стереоизомеров [739].
...
#figure(
  image("image.png"),
  caption: [
    Стереоспецифический анализ триглицеридов по Брохерхофу
    
    где: 1—3 — ацилы жирных кислот; P — Ph — остаток фосфорилфенола; I, V — триглицерид; II, VIII — жирные кислоты; III — _sn_-1,2- и _sn_-2,3-диглицериды; IV — 2-моноглицерид; VI — L- и D-фосфатидилфенолы; VII — L-лизофосфатидилфенол; IX — D-фосфатидилфенол. Реакции: _a_ — липазный гидролиз; _б_ — реакция диглицеридов с фенилдихлорфосфатом; _в_ — гидролиз фосфолипазой А.
  ]
)
...
Для оценки соответствия хода гидролиза статистическому правилу найденный жирнокислотный состав 1,2(2,3)-диглицеридов сравнивали с составом, вычисленным по уравнению $[A]_(1,2(2,3)) = 0,25 (3[A] + [А]₂)$. Оказалось, что состав диглицеридов, полученных гидролизом по Брокерхофу или по Лэндсу [129, 617], значительно отличался от теоретического из-за повышенного содержания насыщенных ацилов. Наилучшие результаты в этом отношении дал микрометод гидролиза [59, 656]. Возможно, что статистический гидролиз можно обеспечить снижением уровня $Ca²⁺$ и увеличением содержания фермента в реакционной смеси [212].

По Брокерхофу, продукты липазного гидролиза разделяли на колонке с силикагелем; диглицериды (выход 20—30%) разделяли на 1,2(2,3)- и 1,3-изомеры на кремнекислоте, пропитанной $H₃BO₃$. Несимметричные диглицериды превращали в фосфатидные кислоты в присутствии фенилдихлорфосфата, эфира и пиридина при 0°. Триэтиламмониевые соли этих кислот гидролизовали фосфолипазой А в эфире, рН 7,5, в присутствии $СаСl₂$ и продукты реакции разделяли хроматографией с $H₃BO₃$ [129, 130, 134, 140]. Жирнокислотный состав каждой фракции определяли газохроматографически. Достоверные результаты состава 1-, 2- и 3-положения можно получить лишь при совпадении данных следующих анализов: I = V, III = VI и IV = VIII (см. выше). Совпадение этих величин показывает, что липазный и фосфолипазный гидролиз прошел статистически и не сопровождался изомеризацией. Непосредственно определялся состав 1- (VII) и 2-положений (IV и VIII); состав 3-положений вычисляли двумя методами: с одной стороны, содержание кислоты в 3-положениях равно $3 × I - IV – VII$, а с другой, $2 × IX — IV$. В этих расчетах допустимо абсолютное расхождение в 4% при содержании данной кислоты в жире $[А] = 40%$ и выше, не более 3% при $[А] = 10—35%$ и не более 2% для минорных компонентов; обычно при анализе состава 3-положений ошибка не превышает ±2% и лишь для трудногидролизуемых насыщенных жиров возрастает до 8% [129, 130, 140, 144, 146]. Если результаты хорошо воспроизводятся, то можно ограничиться определением фракций I, IV, VII и IX [130]. Метод Брокерхофа проверен с синтетическими и полусинтетическими триглицеридами [129].
...
#figure(
  ...
  caption: [
    ...
    _а_ — поперечный разрез; _б_ — поперечный разрез с двумя молекулами (или двойными молекулами), принадлежащими к ячейке; _в_ — поперечный разрез через кристалл
  ]
)
...
#figure(
  ...
  caption: [
    ...
    Конфигурации: 1 — вилки; 2 — кресла; 3 — стержня. Длинный интервал, кратный: _a_ — 2m; _б_ — 3m; _в_ — 4m
  ]
)

Сначала считали, что эти молекулы имеют конфигурацию вилки, а затем предположили, что более плотная упаковка соответствует конфигурации кресла. Проведенный недавно рентгеноструктурный анализ единичного кристалла _β_-полиморфной формы трилаурина (рис. 21) позволил установить, что наиболее экономичная упаковка молекул с наименьшей потенциальной энергией, не противоречащая принципам симметрии, достигается в форме стержня [178, 180]. Можно видеть, что кристалл состоит из _2m_-слоев стержнеобразных молекул в триклинной упаковке; два ацила находятся на одной прямой, а третий (еще не известно, какой именно, средний или один из крайних) расположен рядом параллельно им. Значения угла $β_x$, найденные из рентгенограммы (62°7′) и вычисленные по величине _L_ (61°39′), хорошо совпадали между собой. Стержневидная форма обеспечивает также образование _3m_- и _4m_-слоев в кристалле (см. выше) [178, 423]. Форма молекул в других главных кристаллических модификациях _α_ и _β'_ остается еще не выясненной [619].

#figure(
  image("image.png"),
  caption: [
    Рис. 21. Рентгенограмма _β_-полиморфной формы трилаурина, показывающая размещение триглицерида в кристаллической решетке
    
    _а, с_ — то же, что на рис. 18
  ]
)

В гетерогенных системах фазовые переходы могут быть энантиотропными, т. е. осуществляться обратимо в обоих направлениях без расплавления при повышении или понижении температуры системы, или монотропными, которые необратимы, протекают с потерей свободной энергии в направлении более устойчивой формы и для обратного получения нестабильной полиморфной формы требуют промежуточного расплавления. Для триглицеридов характерны главным образом монотропные переходы [178]. Для получения четких полиморфных переходов и образования форм с определенными свойствами необходимо располагать чистыми препаратами триглицеридов, не содержащими глицеридных гомологов близкого состава или строения. Так, в однородных образцах $Ла₃$ и $С₃$, судя по спектрам ЯМР низкого разрешения, жидкая фаза ниже температуры плавления отсутствовала, а в загрязненных кристаллах _β_-форм ОПП, ПОП, ПОО и СОС жидкая фаза появлялась задолго до плавления [205, 746]. Обычно в переохлажденных расплавах непосредственно ниже точки плавления _β_-формы наблюдается перелом кривых зависимости $lg η$ (_η_ — вязкость) от обратной температуры $Т⁻¹$, указывающий на усиление агрегации глицеридных молекул в параллельной упаковке. Сразу же после расплавления триглицерида его кристаллическая структура частично сохраняется, поскольку быстрое охлаждение такого расплава приводит к немедленной рекристаллизации. После разрушения частично упорядоченной структуры жидкой фазы путем получасового выдерживания при температуре, на 20° превышающей температуру плавления, кристаллы образуются медленно [182, 783, 929]. При кристаллизации трипальмитина свойства образующихся кристаллов _β_-формы определяются природой растворителя: кристаллы наибольшего размера получаются из ацетона, а кристаллы, осажденные из гексана, толуола, бензола и хлороформа, резко отличаются от них по форме и величине [57].

#align(center)[
  #strong[Таблица 11] \
  #strong[Физические свойства главных полиморфных форм простых насыщенных триглицеридов * [178, 313]]
]

#table(
  columns: (auto, auto, auto, auto, auto, auto, auto, auto, auto, auto, auto, auto),
  stroke: 0.4pt,
  [*Обозначение данной формы по номенклатуре*], [], [], [*Угол βx*], [*Наличие чередования точек плавления **], [*Длина L***, Å*], [*Величина s****, Å*], [], [],
  [Малкина], [Луттона], [Ганстоуна], [], [], [], [a], [б],
  [Стекловидная], [$α_L$], [V], [90], [Нет (54,5)], [4,15], [4,9], [3,4],
  [$β'_M$], [$β'_U$], [U], [68], [Нет (65,0)], [3,8 и 4,2], [4,3], [3,7],
...
#figure(
  image("image.png"),
  caption: [
    Рис. 22. Дилатометрические (1) и температурные (2) кривые метастабильной _α_- и стабильной _β_-полиморфной формы трилаурина (_а, б_), трипальмитина (_в, г_) и тристеарина (_д, е_)
    
    _а, в, д_ — _α_-формы; _б, г, е_ — _β_-формы
  ]
)
...
#figure(
  ...
  caption: [
    ...
    _α_ — _α_; _б_ — _β'_; _в_ — _β_
  ]
)

Дилатометрия регистрирует увеличение удельного объема ($V_s$ в мл/г) триглицерида в одной из точек фазового перехода — точке плавления, а также равное по абсолютной величине сжатие в точке затвердевания; оба эти процесса регистрируются как функции температуры [27, 379]. Приведем величины «скачка» $V_s$ в мл × $10⁻²$ г при плавлении некоторых глицеридов: ООО — 6,65, СОО — 9,05, ССС — 9,25, ОПП — 9,65, ПСС — 14,06, СПП — 14,60, ССС — 15,16, ППП — 16,21 [126]. При нагревании _α_- и _β_-форм $Ла₃$, $П₃$ и $С₃$ в микродилатометре со скоростью 6,4° в 1 мин. (рис. 22) было обнаружено, что различия между исходной и конечной величиной $V_s$ при плавлении _β_-формы связаны с образованием при застывании расплава промежуточной _β'_-формы для $П₃$ и метастабильной _α_-формы для всех триглицеридов, устойчивость которой возрастает с увеличением _m_ и нагревание которой приводит к образованию _β_-формы [27].
...
В образующейся из расплава $α_L$-форме, свойства которой были приведены в табл. 11, цепи отдалены друг от друга на расстояние около 5 Å и свободно вращаются вокруг своей вертикальной оси. Наличие в спектре многочисленных полос $α_L$-формы в области 1250 $см⁻¹$ доказывает, что эта форма является кристаллической, а не стекловидной, как считал Малкин. У глицеридов от $Ла₃$ и выше, обладающих сравнительно устойчивой $α_L$-формой, число этих полос равно _m_/2, что позволяет устанавливать длину ацилов в глицеридах по ИК-спектру [178].

Свойства $β'_L$-формы (табл. 11) указывают на обычную орторомбическую упаковку двух типов наклонных алифатических цепей, плоскости которых ориентированы под прямыми углами друг к другу. Наблюдалось образование $β'_C$-формы $С₃$ при кристаллизации из парафинового масла [178, 746].

Наконец, $β_L$-форма (табл. 11) соответствует триклинной системе, где все плоскости зигзагообразных жирных цепей параллельны друг другу, а сами цепи значительно более устойчивы и упакованы более плотно, чем у _α_-формы; амплитуда вращательных колебаний цепей вокруг вертикальной оси для $С₃$ не превышает 17° [178].

#align(center)[
  #strong[Таблица 12] \
  #strong[Главные полосы поглощения простых тринасыщенных триглицеридов в инфракрасном спектре]
]
...
Номенклатуры Малкина и Луттона не позволяют сравнивать триглицериды по свойствам их полиморфных форм с другими алифатическими соединениями. В номенклатуре Ганстоуна [313] полиморфные формы всех насыщенных соединений с длинной цепью подразделяются по величине угла $β_x$ на пять групп, причем триглицериды входят в три первых группы V, U и Т (табл. 11). Величину L в кристаллах одно-, двух- и трехкислотных $S₃$-триглицеридов вида АВС (ацил В всегда в 2-положении), являющуюся линейной функцией длины цепи _m_, можно вычислить по уравнению $L = 1,28 × sin β_x (m_A + m_B + m_C) + c$, где $m_A, m_B, m_C$ — число атомов углерода в ацилах А, В и С, а _c_ — постоянное приращение L в Å, отражающее длину остатка глицерина и величину зоны контакта сложноэфирных групп; величины _c_ для _2m_- и _3m_-слоев простых и смешанных триглицеридов с разной длиной ацилов А, В и С приведены в табл. 11. Для двойного (2m) слоя значение $m_д$ в уравнении Ганстоуна считают равным нулю. Вычисленные и найденные рентгеноструктурным методом величины L хорошо совпадали между собой [313]. Номенклатура Ганстоуна впервые показала, что каждая полиморфная форма характеризуется определенной величиной угла наклона; однако эта номенклатура непригодна для вычисления L ненасыщенных глицеридов и не учитывает добавочные полиморфные формы простых $S₃$-глицеридов, совпадающие с основными по величине $β_x$ [619].

К таким добавочным формам относится, например, _sub_-$α_L$-форма, которая получается без плавления из $α_L$-формы $С₃$ при −50°, обратимо превращается в $α_L$-форму и по всем изученным показателям, кроме величины угла $β_x = 90°$, совпадает с $β'_L$-формой. Иногда при кристаллизации из растворителя или при нагревании _α_-формы возникают несколько устойчивых $β_L$-форм, идентичных по картине дифракции, но различающихся по величине $β_x$. В отличие от «четных» триглицеридов, триглицериды «нечетных» кислот наиболее устойчивы не в $β_L$, а в $β'_L$-форме [176, 178, 746].

Возникновение добавочных форм пытались учесть номенклатуры Хора и Ларсона. По Хору, имеются четыре полиморфных формы — _α, β'_, промежуточная и _β_, в порядке повышения температуры плавления. Обозначенная «промежуточной» модификация, которая возникает при нагреве _α_-формы, как было показано позднее, оказалась смесью равных количеств орторомбической и триклинной форм [313, 379].

По Ларсону: 1) формы с одним S = 4,15 Å обозначаются _α_; 2) формы с двумя S = 4,2 и 3,8 Å и дублетом при 720 $см⁻¹$ обозначаются _β'_, а все формы, не удовлетворяющие критериям 1 и 2, обозначаются _β_; если у данного глицерида есть несколько _β_-форм, то они обозначаются $β₁, β₂$ и т. д., в порядке снижения температуры плавления. У _β_-форм по Ларсону все плоскости зигзагообразных цепей параллельны, у _β'_-форм — перпендикулярны, а у _α_-форм в размещении плоскостей нет определенной закономерности [619].

Несмотря на свои недостатки, наиболее приемлемой в настоящее время является номенклатура Луттона, включающая три главные полиморфные формы простых $S₃$-триглицеридов — неустойчивую _α_, промежуточную _β'_ и устойчивую _β_. Эти главные формы следует рассматривать как совокупности близких по свойствам, но не идентичных кристаллических модификаций. Для разработки более полной классификации необходимы дальнейшие исследования [178].
...
#align(center)[
  #strong[Таблица 13] \
  #strong[Полиморфные формы некоторых насыщенных двух- и трехкислотных триглицеридов]
]
...
#table(
  ...
  [МПМ ***], [+2], [+], [−], [+], [], [MMM],
  [CMC ****], [−4], [+], [+], [+], [$β_L-4$], [CCC],
  [СЛаЛа], [−6], [+], [+], [−], [$β_L-3, β'_L-3$], [],
  [СУУ *****], [−16], [+], [+], [−], [_sub_-$α_L$, $α_L-1$, _super_-$α_L$], [],
  [СКРКр ******], [−12], [+], [+], [+], [_sub_-$β'_L-4$, _sub_-$β_L-4$], [],
  [СПКа], [+], [+], [+], [+], [$β'_L-3$, две $β_L$-формы], [],
)
* $β'_L$- и $β_L$-Формы одинаково устойчивы. \
** $β'_L$-Форма наиболее устойчива. \
*** $β_L$-Форма наиболее устойчива; $β'_L$-форма трудно уловима. \
...
Кроме ССО наиболее изучены по полиморфизму SSU-глицериды свиного жира (стр. 207) [819], главный триглицерид которого по всем свойствам полиморфных форм совпадает с ОПС [181]; его наиболее легкоплавкой формой является _sub_-$α_L-2$, а возникающей из расплава формой $α_L-2(25°)$, которую можно перевести нагреванием в более устойчивую _sub_-$β'_L-3$-форму (37°) с L = 69 Å и S = 4,08 и 3,75 Å. Наиболее стойкую $β_L-3$-форму (40°) получают кристаллизацией из растворителя или нагреванием _sub_-$β_L-3$-формы [611], крупнозернистые кристаллы которой возникают при хранении свиного жира при 27°, что ухудшает внешний вид пищевых продуктов [930]; это явление устраняют переэтерификацией (стр. 107) [805]. В отличие от ОПС, ССО и ПОО, симметричные глицериды свиного жира ОСО и ОПО дают формы $α_L$, $β'_L-2$ и $β_L-3$, из которых последняя является устойчивой [661].
